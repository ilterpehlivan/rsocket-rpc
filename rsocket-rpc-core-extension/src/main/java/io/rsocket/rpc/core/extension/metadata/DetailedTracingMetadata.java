...
public class DetailedTracingMetadata implements MetadataAware {
  ...
  public DetailedTracingMetadata() {}

  public DetailedTracingMetadata(long traceIdHigh, long traceIdLow, long spanId, long parentSpanId) {
  ...
  public static DetailedTracingMetadata from(ByteBuf content) {
    DetailedTracingMetadata temp = new DetailedTracingMetadata();
    temp.load(content);
    return temp;
  }
}
